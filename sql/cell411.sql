...
ALTER TABLE public."ChatMsg" OWNER TO parse;

--
-- Name: ChatRoom; Type: TABLE; Schema: public; Owner: parse
--
...
ALTER TABLE public."ChatRoom" OWNER TO parse;
...
--
-- Name: RevGeoCache; Type: TABLE; Schema: public; Owner: parse
--

CREATE TABLE public."RevGeoCache" (
    "objectId" text NOT NULL,
    "createdAt" timestamp with time zone,
    "updatedAt" timestamp with time zone,
    _rperm text[],
...
ALTER TABLE public."RevGeoCache" OWNER TO parse;
...
CREATE VIEW public.counts AS
 SELECT x.tab,
   ...
   FROM ( SELECT 'Alert                      '::text AS tab,
           ...
           FROM public."Alert"
        UNION
         SELECT 'ChatMsg                    '::text AS tab,
            count(*) AS cnt
           FROM public."ChatMsg"
        UNION
         SELECT 'ChatRoom                   '::text AS tab,
            count(*) AS cnt
...
--
-- Name: dupUsers; Type: TABLE; Schema: public; Owner: parse
--

CREATE TABLE public."dupUsers" (
    "objectId" text,
    "createdAt" timestamp with time zone,
    "updatedAt" timestamp with time zone,
    username text,
...
ALTER TABLE public."dupUsers" OWNER TO parse;
...
--
-- Name: ChatMsg ChatMsg_pkey; Type: CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: ChatRoom ChatRoom_pkey; Type: CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: RevGeoCache RevGeoCache_pkey; Type: CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."RevGeoCache"
    ADD CONSTRAINT "RevGeoCache_pkey" PRIMARY KEY ("objectId");
...
--
-- Name: _Join:friends:_User_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:friends:_User_uniq" ON public."_Join:friends:_User" USING btree ("owningId", "relatedId");


--
-- Name: _Join:members:PrivateCell_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:members:PrivateCell_uniq" ON public."_Join:members:PrivateCell" USING btree ("owningId", "relatedId");


--
-- Name: _Join:members:PublicCell_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:members:PublicCell_uniq" ON public."_Join:members:PublicCell" USING btree ("owningId", "relatedId");


--
-- Name: _Join:roles:_Role_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:roles:_Role_uniq" ON public."_Join:roles:_Role" USING btree ("owningId", "relatedId");


--
-- Name: _Join:spamUsers:_User_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:spamUsers:_User_uniq" ON public."_Join:spamUsers:_User" USING btree ("owningId", "relatedId");


--
-- Name: _Join:users:_Role_uniq; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_Join:users:_Role_uniq" ON public."_Join:users:_Role" USING btree ("owningId", "relatedId");
...
--
-- Name: _User_phone_unique; Type: INDEX; Schema: public; Owner: parse
--

CREATE UNIQUE INDEX "_User_phone_unique" ON public."_User" USING btree ("mobileNumber");
...
--
-- Name: Alert Alert_chatRoom; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Alert"
    ADD CONSTRAINT "Alert_chatRoom" FOREIGN KEY ("chatRoom") REFERENCES public."ChatRoom"("objectId") ON DELETE CASCADE;


--
-- Name: Alert Alert_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Alert"
    ADD CONSTRAINT "Alert_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: ChatMsg ChatMsg_chatRoom; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."ChatMsg"
    ADD CONSTRAINT "ChatMsg_chatRoom" FOREIGN KEY ("chatRoom") REFERENCES public."ChatRoom"("objectId") ON DELETE CASCADE;


--
-- Name: ChatMsg ChatMsg_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."ChatMsg"
    ADD CONSTRAINT "ChatMsg_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: PrivateCell PrivateCell_chatRoom; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."PrivateCell"
    ADD CONSTRAINT "PrivateCell_chatRoom" FOREIGN KEY ("chatRoom") REFERENCES public."ChatRoom"("objectId") ON DELETE CASCADE;


--
-- Name: PrivateCell PrivateCell_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."PrivateCell"
    ADD CONSTRAINT "PrivateCell_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: PublicCell PublicCell_chatRoom; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."PublicCell"
    ADD CONSTRAINT "PublicCell_chatRoom" FOREIGN KEY ("chatRoom") REFERENCES public."ChatRoom"("objectId") ON DELETE CASCADE;


--
-- Name: PublicCell PublicCell_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."PublicCell"
    ADD CONSTRAINT "PublicCell_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: PushLog PushLog_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."PushLog"
    ADD CONSTRAINT "PushLog_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: Request Request_cell; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Request"
    ADD CONSTRAINT "Request_cell" FOREIGN KEY (cell) REFERENCES public."PublicCell"("objectId") ON DELETE CASCADE;


--
-- Name: Request Request_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Request"
    ADD CONSTRAINT "Request_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: Request Request_sentTo; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Request"
    ADD CONSTRAINT "Request_sentTo" FOREIGN KEY ("sentTo") REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: Response Response_alert; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Response"
    ADD CONSTRAINT "Response_alert" FOREIGN KEY (alert) REFERENCES public."Alert"("objectId") ON DELETE CASCADE;


--
-- Name: Response Response_forwardedBy; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Response"
    ADD CONSTRAINT "Response_forwardedBy" FOREIGN KEY ("forwardedBy") REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: Response Response_owner; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."Response"
    ADD CONSTRAINT "Response_owner" FOREIGN KEY (owner) REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: _User _User_lastConsent; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_User"
    ADD CONSTRAINT "_User_lastConsent" FOREIGN KEY ("lastConsent") REFERENCES public."PrivacyPolicy"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:friends:_User fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:friends:_User"
    ADD CONSTRAINT fkey_owning FOREIGN KEY ("owningId") REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:spamUsers:_User fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:members:PrivateCell fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:members:PrivateCell"
    ADD CONSTRAINT fkey_owning FOREIGN KEY ("owningId") REFERENCES public."PrivateCell"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:members:PublicCell fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:members:PublicCell"
    ADD CONSTRAINT fkey_owning FOREIGN KEY ("owningId") REFERENCES public."PublicCell"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:users:_Role fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:users:_Role"
    ADD CONSTRAINT fkey_owning FOREIGN KEY ("owningId") REFERENCES public."_Role"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:roles:_Role fkey_owning; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:friends:_User fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:friends:_User"
    ADD CONSTRAINT fkey_related FOREIGN KEY ("relatedId") REFERENCES public."_User"("objectId") ON DELETE CASCADE;


--
-- Name: _Join:spamUsers:_User fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:members:PrivateCell fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:members:PublicCell fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:users:_Role fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--
...
--
-- Name: _Join:roles:_Role fkey_related; Type: FK CONSTRAINT; Schema: public; Owner: parse
--

ALTER TABLE ONLY public."_Join:roles:_Role"
    ADD CONSTRAINT fkey_related FOREIGN KEY ("relatedId") REFERENCES public."_Role"("objectId") ON DELETE CASCADE;
