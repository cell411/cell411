...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/MAGCheckbox/MAGCheckbox.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Parse.default-FacebookUtils/Parse.bundle"
fi
