...
public class ParsePolygon implements Parcelable {
  ...
  /**
   * Creates a new polygon instance from a {@link Parcel} source. This is used when unparceling a
  ...
  /**
   * Creates a new polygon instance from a {@link Parcel} using the given {@link ParseParcelDecoder}.
   ...
   */
  @SuppressWarnings("unused")
  public ParsePolygon(Parcel source, ParseParcelDecoder decoder) {
  ...
  public boolean containsPoint(ParseGeoPoint point) {
    ...
    boolean outside = point.getLatitude() < minX || point.getLatitude() > maxX || point.getLongitude() < minY ||
