...
public class ManifestInfo {
  private static final String TAG = "com.parse.android.ManifestInfo";
  ...
  public static List<ResolveInfo> getIntentReceivers(String... actions) {
    ...
    for (String action : actions) {
      list.addAll(pm.queryBroadcastReceivers(new Intent(action), PackageManager.GET_INTENT_FILTERS));
    }
