...
public class ParseTaskUtils {
   ...
   */
  /* package */
  public static Task<Void> callbackOnMainThreadAsync(
  ...
  /* package */
  public static Task<Void> callbackOnMainThreadAsync(
      Task<Void> task, final ParseCallback1<ParseException> callback, final boolean reportCancellation
  )
  {
    if (callback == null) {
      return task;
   ...
   */
  /* package */
  public static <T> Task<T> callbackOnMainThreadAsync(
  ...
  /* package */
  public static <T> Task<T> callbackOnMainThreadAsync(
      Task<T> task, final ParseCallback2<T, ParseException> callback, final boolean reportCancellation
  )
  {
    if (callback == null) {
      return task;
