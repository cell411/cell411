...
public class ParseRESTConfigCommand extends ParseRESTCommand {
  ...
  public static ParseRESTConfigCommand fetchConfigCommand(String sessionToken) {
    return new ParseRESTConfigCommand("config", ParseHttpMethod.GET, null, sessionToken);
  }
  ...
  )
  {
    ...
    return new ParseRESTConfigCommand("config", ParseHttpMethod.PUT, commandParameters, sessionToken);
  }
}
