...
public class ParseRESTQueryCommand extends ParseRESTCommand {
  ...
  private static final String TAG = ParseRESTQueryCommand.class.getSimpleName();

  public ParseRESTQueryCommand(String httpPath, ParseHttpMethod httpMethod, Map<String, ?> parameters,
                               String sessionToken)
  {
    super(httpPath, httpMethod, parameters, sessionToken);
    Log.i(TAG, httpMethod + "  " + createUrl(httpPath));
  ...
  )
  {
    ...
    return new ParseRESTQueryCommand(httpPath, ParseHttpMethod.GET, parameters, sessionToken);
  }
  ...
  /* package */
  public static <T extends ParseObject> Map<String, String> encode(ParseQuery.State<T> state, boolean count)
  {
    ...
    // com.parse-server supports it. Currently with our APIs, when counting, limit will always be 0,
