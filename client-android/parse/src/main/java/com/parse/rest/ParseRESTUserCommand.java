...
public class ParseRESTUserCommand extends ParseRESTCommand {
  ...
  public static ParseRESTUserCommand getCurrentUserCommand(String sessionToken) {
    return new ParseRESTUserCommand("users/me", ParseHttpMethod.GET, null, sessionToken);
  }
  ...
  {
    return new ParseRESTUserCommand("users", ParseHttpMethod.POST, parameters, sessionToken, revocableSession);
  }
  ...
  )
  {
    ...
    return new ParseRESTUserCommand("login", ParseHttpMethod.GET, parameters, null, revocableSession);
  }
  ...
  public static ParseRESTUserCommand resetPasswordResetCommand(String email) {
    ...
    return new ParseRESTUserCommand("requestPasswordReset", ParseHttpMethod.POST, parameters, null);
  }
