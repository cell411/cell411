...
public class ParseRESTFileCommand extends ParseRESTCommand {
  ...
  protected ParseHttpBody newBody(final ProgressCallback progressCallback) {
    ...
    if (progressCallback == null) {
      return data != null ? new ParseByteArrayHttpBody(data, contentType, this) :
             new ParseFileHttpBody(file, contentType);
    }
    return data != null ? new ParseCountingByteArrayHttpBody(data, contentType, progressCallback) :
