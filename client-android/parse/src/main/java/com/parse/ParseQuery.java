...
public class ParseQuery<T extends ParseObject> {
  ...
  public static <T extends ParseObject> ParseQuery<T> or(ParseQuery<T> q1,
                                                         ParseQuery<T> q2,
                                                         ParseQuery<T> q3)
  {
    return or(Arrays.asList(q1, q2, q3));
  }
   ...
   * <p/>
   *
   * @return A list of all {@link ParseObject}s obeying the conditions set
   *      in this query.
   */
  ...
  public static class State<T extends ParseObject> {
    ...
    public static class Builder<T extends ParseObject> {
      ...
      public Builder<T> whereNear(String key, ParseGeoPoint point) {
        if(point==null)
          throw new IllegalArgumentException("whereNear missing point");
