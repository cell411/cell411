 ...
 */
public class OfflineSQLiteOpenHelper extends com.parse.offline.ParseSQLiteOpenHelper {
  ...
  private void createSchema(SQLiteDatabase db) {
    ...
    sql = "CREATE TABLE " + TABLE_OBJECTS + " (" + KEY_UUID + " TEXT PRIMARY KEY, " + KEY_CLASS_NAME +
        " TEXT NOT NULL, " + KEY_OBJECT_ID + " TEXT, " + KEY_JSON + " TEXT, " + KEY_IS_DELETING_EVENTUALLY +
        " INTEGER DEFAULT 0, " + "UNIQUE(" + KEY_CLASS_NAME + ", " + KEY_OBJECT_ID + ")" + ");";
    db.execSQL(sql);
