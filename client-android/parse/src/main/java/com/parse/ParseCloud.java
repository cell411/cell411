 ...
 * {@link #run(String, Map)} call which do block the calling thread. For example, if your
...
public final class ParseCloud {
  ...
  public static <T> T run(@NonNull String name, @NonNull Map<String, ?> params) throws ParseException
  {
    return ParseSyncUtils.run(name, params);
  }
  ...
  public static <T> void callFunctionInBackground(
      @NonNull String name, @NonNull Map<String, ?> params, @NonNull FunctionCallback<T> callback
  )
  {
