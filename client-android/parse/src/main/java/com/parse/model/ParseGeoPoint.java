...
import com.parse.android.LocationNotifier;
import com.parse.boltsinternal.Continuation;
import com.parse.boltsinternal.Task;
import com.parse.callback.LocationCallback;
...
public class ParseGeoPoint implements Parcelable {
   ...
   */
  public ParseGeoPoint(Parcel source, ParseParcelDecoder decoder) {
  ...
  public boolean equals(Object obj) {
    ...
    return ((ParseGeoPoint) obj).getLatitude() == latitude && ((ParseGeoPoint) obj).getLongitude() == longitude;
  }
