...
import com.parse.callback.ConfigCallback;
import com.parse.codec.ParseDecoder;
import com.parse.codec.PointerEncoder;
import com.parse.controller.ParseConfigController;
...
public class ParseConfig {
  ...
  public static ParseConfig getCurrentConfig() {
    try {
      return ParseTaskUtils.wait(getConfigController().getCurrentConfigController().getCurrentConfigAsync());
  ...
  /* package */ public static ParseConfig decode(JSONObject json, ParseDecoder decoder) {
  ...
  public <T> List<T> getList(String key, List<T> defaultValue) {
    ...
    @SuppressWarnings("unchecked") List<T> returnValue = (value instanceof List) ? (List<T>) value : defaultValue;
    return returnValue;
  }
  ...
  public <V> Map<String, V> getMap(String key, Map<String, V> defaultValue) {
    ...
    @SuppressWarnings("unchecked") Map<String, V> returnValue = (value instanceof Map) ? (Map<String, V>) value :
                                                                defaultValue;
    return returnValue;
  }
