...
public final class ParseFieldOperations {
  ...
  public static ParseFieldOperation decode(JSONObject encoded, ParseDecoder decoder) throws JSONException {
    ...
    if (factory == null) {
      throw new RuntimeException("Unable to decodeObject operation of type " + op);
    }
   ...
   * @return A ParseFieldOperation.
   */
  static public ParseFieldOperation decode(Parcel source, ParseParcelDecoder decoder) {
