...
public class ParseRelationOperation<T extends ParseObject> implements ParseFieldOperation {
  ...
  private ParseRelationOperation(
      String newTargetClass, Set<ParseObject> newRelationsToAdd, Set<ParseObject> newRelationsToRemove
  )
  {
  ...
  public ParseFieldOperation mergeWithPrevious(ParseFieldOperation previous) {
    if (previous == null) {
      ...
      @SuppressWarnings("unchecked") ParseRelationOperation<T> previousOperation = (ParseRelationOperation<T>) previous;

      if (previousOperation.targetClass != null && !previousOperation.targetClass.equals(targetClass)) {
        throw new IllegalArgumentException(
            "Related object object must be of class " + previousOperation.targetClass + ", but " + targetClass +
                " was passed in.");
      }
  ...
  public Object apply(Object oldValue, String key) {
    ...
    if (oldValue == null) {
      ...
      if (targetClass != null && !targetClass.equals(relation.getTargetClass())) {
        throw new IllegalArgumentException(
            "Related object object must be of class " + relation.getTargetClass() + ", but " + targetClass +
                " was passed in.");
      }
    } else {
      throw new IllegalArgumentException("Operation is invalid after previous operation.");
