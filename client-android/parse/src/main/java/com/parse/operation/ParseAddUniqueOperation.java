...
public class ParseAddUniqueOperation implements ParseFieldOperation {
  ...
  public ParseFieldOperation mergeWithPrevious(ParseFieldOperation previous) {
    if (previous == null) {
      ...
      List<Object> previousResult = new ArrayList<>(((ParseAddUniqueOperation) previous).objects);
  ...
  public Object apply(Object oldValue, String key) {
    if (oldValue == null) {
      ...
      @SuppressWarnings("unchecked") ArrayList<Object> newValue = (ArrayList<Object>) this.apply(old, key);
