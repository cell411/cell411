...
import com.parse.rest.ParseRESTObjectBatchCommand;
...
public class NetworkObjectController implements ParseObjectController {
  ...
  {
    final ParseRESTCommand command = ParseRESTObjectCommand.getObjectCommand(state.objectId(), state.className(),
                                                                             sessionToken);
  ...
  public Task<ParseObject.State> saveAsync(
      final ParseObject.State state, final ParseOperationSet operations, String sessionToken, final ParseDecoder decoder
  )
  {
    /*
  ...
  public List<Task<ParseObject.State>> saveAllAsync(
      List<ParseObject.State> states, List<ParseOperationSet> operationsList, String sessionToken,
