...
public class Drawable2d {
  ...
  /**
   * Simple square, specified as a triangle strip.  The square is centered
   * on (0,0) and has
   * a size of 1x1.
   * <p>
   ...
   * <p>
   * The texture coordinates are Y-inverted relative to RECTANGLE.  (This
   * seems to work out
  ...
  /**
   * Returns the number of position coordinates per vertex.  This will be 2
   * or 3.
   */
