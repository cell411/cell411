...
public class TitlePageIndicator extends View implements PageIndicator {
  ...
  public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle)
  {
    ...
    final float defaultFooterIndicatorHeight = res.getDimension(
      R.dimen.default_title_indicator_footer_indicator_height);
    final float defaultFooterIndicatorUnderlinePadding = res.getDimension(
      R.dimen.default_title_indicator_footer_indicator_underline_padding);
  ...
  {
    CharSequence title = mViewPager.getAdapter()
                                   .getPageTitle(i);
    if (title == null) {
      title = EMPTY_TITLE;
    }
